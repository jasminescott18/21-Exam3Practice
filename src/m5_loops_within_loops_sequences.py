...
def run_test_integers():
    ...
    # Test 2:
    expected = [1, 1, 80, 1, 3, 4, 30, 4]
    answer = integers([(1, 1, 80),
                       ('hmm', 'hi', 'boyfriend'),
                       [1, 2.5, 3, 4],
                       'hello',
                       [],
...
def run_test_big_letters():
    ...
    # Test 2:
    expected = 'OOOHHVGTTBULLADBZBBOO'
    answer = big_letters([(2, 4, 6),
                          'OOOHH lala',
                          (10, 'Ok what is ThiSSS?', 10),
                          [],
                          'oops',
                          'VeGeTa',
                          ['Bulma'],
